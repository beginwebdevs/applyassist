        ...
        <div className="card">
            <div className="inner relative border border-[#AEAEAE] rounded-lg hover:border-[2px] border-[#7C878E] p-4">
                ...
                <div className="card-title h-[50px] my-6">
                    <h1 className="text-xl font-semibold">{ data.course_name }</h1>
                </div>
                <div className="university flex w-full mb-4">
                    <p className="text-md font-semibold">{ data.institution_name }</p>
                ...
                <div className="action flex absolute top-4 right-4">
                    <span className="w-[30px] h-[30px] hover:bg-[#7C878E] cursor-pointer bg-[#AEAEAE] flex rounded-[50%] text-[#ffffff] justify-center items-center mr-1"><i class="fa-solid fa-code-compare"></i></span>
